...
pub struct ActiveDirectoryProperties {
    ...
    #[serde(rename = "azureStorageSid", default, skip_serializing_if = "Option::is_none")]
...
pub mod active_directory_properties {
    ...
    impl Serialize for AccountType {
        ...
        {
            match self {
                Self::User => serializer.serialize_unit_variant("AccountType", 0u32, "User"),
                Self::Computer => serializer.serialize_unit_variant("AccountType", 1u32, "Computer"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl Serialize for DirectoryServiceOptions {
            ...
            S: Serializer,
        {
            match self {
                ...
                Self::Aadkerb => serializer.serialize_unit_variant("DirectoryServiceOptions", 3u32, "AADKERB"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
#[doc = "This property defines the creation time based filtering condition. Blob Inventory schema parameter 'Creation-Time' is mandatory with this filter."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize, Default)]
pub struct BlobInventoryCreationTime {
    #[doc = "When set the policy filters the objects that are created in the last N days. Where N is an integer value between 1 to 36500."]
    #[serde(rename = "lastNDays", default, skip_serializing_if = "Option::is_none")]
    pub last_n_days: Option<i32>,
}
impl BlobInventoryCreationTime {
    pub fn new() -> Self {
        Self::default()
    }
}
...
pub struct BlobInventoryPolicyFilter {
    ...
    pub creation_time: Option<BlobInventoryCreationTime>,
}
...
pub struct GeoReplicationStats {
    ...
    #[doc = "A boolean flag which indicates whether or not planned account failover is supported for the account."]
    #[serde(rename = "canPlannedFailover", default, skip_serializing_if = "Option::is_none")]
    pub can_planned_failover: Option<bool>,
    #[doc = "The redundancy type of the account after an account failover is performed."]
...
pub mod geo_replication_stats {
    ...
    #[doc = "The redundancy type of the account after an account failover is performed."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PostFailoverRedundancy")]
    pub enum PostFailoverRedundancy {
    ...
    impl FromStr for PostFailoverRedundancy {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PostFailoverRedundancy {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PostFailoverRedundancy {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::StandardLrs => serializer.serialize_unit_variant("PostFailoverRedundancy", 0u32, "Standard_LRS"),
                Self::StandardZrs => serializer.serialize_unit_variant("PostFailoverRedundancy", 1u32, "Standard_ZRS"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    #[doc = "The redundancy type of the account after a planned account failover is performed."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "PostPlannedFailoverRedundancy")]
    pub enum PostPlannedFailoverRedundancy {
    ...
    impl FromStr for PostPlannedFailoverRedundancy {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for PostPlannedFailoverRedundancy {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for PostPlannedFailoverRedundancy {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::StandardGrs => serializer.serialize_unit_variant("PostPlannedFailoverRedundancy", 0u32, "Standard_GRS"),
                Self::StandardGzrs => serializer.serialize_unit_variant("PostPlannedFailoverRedundancy", 1u32, "Standard_GZRS"),
                Self::StandardRagrs => serializer.serialize_unit_variant("PostPlannedFailoverRedundancy", 2u32, "Standard_RAGRS"),
                Self::StandardRagzrs => serializer.serialize_unit_variant("PostPlannedFailoverRedundancy", 3u32, "Standard_RAGZRS"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub struct ManagementPolicyBaseBlob {
    ...
    #[doc = "Object to define the base blob action conditions. Properties daysAfterModificationGreaterThan, daysAfterLastAccessTimeGreaterThan and daysAfterCreationGreaterThan are mutually exclusive. The daysAfterLastTierChangeGreaterThan property is only applicable for tierToArchive actions which requires daysAfterModificationGreaterThan to be set, also it cannot be used in conjunction with daysAfterLastAccessTimeGreaterThan or daysAfterCreationGreaterThan."]
    #[serde(rename = "tierToCold", default, skip_serializing_if = "Option::is_none")]
    pub tier_to_cold: Option<DateAfterModification>,
    #[doc = "Object to define the base blob action conditions. Properties daysAfterModificationGreaterThan, daysAfterLastAccessTimeGreaterThan and daysAfterCreationGreaterThan are mutually exclusive. The daysAfterLastTierChangeGreaterThan property is only applicable for tierToArchive actions which requires daysAfterModificationGreaterThan to be set, also it cannot be used in conjunction with daysAfterLastAccessTimeGreaterThan or daysAfterCreationGreaterThan."]
    #[serde(rename = "tierToHot", default, skip_serializing_if = "Option::is_none")]
    pub tier_to_hot: Option<DateAfterModification>,
    #[doc = "Object to define the base blob action conditions. Properties daysAfterModificationGreaterThan, daysAfterLastAccessTimeGreaterThan and daysAfterCreationGreaterThan are mutually exclusive. The daysAfterLastTierChangeGreaterThan property is only applicable for tierToArchive actions which requires daysAfterModificationGreaterThan to be set, also it cannot be used in conjunction with daysAfterLastAccessTimeGreaterThan or daysAfterCreationGreaterThan."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
pub struct ManagementPolicySnapShot {
    ...
    #[doc = "Object to define snapshot and version action conditions."]
    #[serde(rename = "tierToCold", default, skip_serializing_if = "Option::is_none")]
    pub tier_to_cold: Option<DateAfterCreation>,
    #[doc = "Object to define snapshot and version action conditions."]
    #[serde(rename = "tierToHot", default, skip_serializing_if = "Option::is_none")]
    pub tier_to_hot: Option<DateAfterCreation>,
    #[doc = "Object to define snapshot and version action conditions."]
    #[serde(default, skip_serializing_if = "Option::is_none")]
...
#[doc = "The parameters or status associated with an ongoing or enqueued storage account migration in order to update its current SKU or region."]
#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct StorageAccountMigration {
    #[doc = "Migration Resource Id"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub id: Option<String>,
    #[doc = "current value is 'default' for customer initiated migration"]
    #[serde(default, skip_serializing_if = "Option::is_none")]
    pub name: Option<String>,
    #[doc = "SrpAccountMigrationType in ARM contract which is 'accountMigrations'"]
    #[serde(rename = "type", default, skip_serializing_if = "Option::is_none")]
    pub type_: Option<String>,
    #[doc = "The properties of a storage account’s ongoing or enqueued migration."]
    pub properties: storage_account_migration::Properties,
}
impl StorageAccountMigration {
    pub fn new(properties: storage_account_migration::Properties) -> Self {
        Self {
            id: None,
            name: None,
            type_: None,
...
pub mod storage_account_migration {
    use super::*;
    #[doc = "The properties of a storage account’s ongoing or enqueued migration."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    pub struct Properties {
        ...
        pub migration_status: Option<properties::MigrationStatus>,
        #[doc = "Error code for migration failure"]
    ...
    impl Properties {
        pub fn new(target_sku_name: SkuName) -> Self {
            Self {
                target_sku_name,
                migration_status: None,
                migration_failed_reason: None,
                migration_failed_detailed_reason: None,
            }
        }
    }
    pub mod properties {
        ...
        impl Serialize for MigrationStatus {
            ...
            {
                match self {
                    Self::Invalid => serializer.serialize_unit_variant("MigrationStatus", 0u32, "Invalid"),
                    Self::SubmittedForConversion => serializer.serialize_unit_variant("MigrationStatus", 1u32, "SubmittedForConversion"),
                    Self::InProgress => serializer.serialize_unit_variant("MigrationStatus", 2u32, "InProgress"),
                    Self::Complete => serializer.serialize_unit_variant("MigrationStatus", 3u32, "Complete"),
                    Self::Failed => serializer.serialize_unit_variant("MigrationStatus", 4u32, "Failed"),
                    Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
                }
            }
        }
...
pub struct StorageAccountProperties {
    ...
    #[doc = "Allow or disallow public access to all blobs or containers in the storage account. The default interpretation is false for this property."]
    ...
    #[doc = "This property will be set to true or false on an event of ongoing migration. Default value is null."]
...
pub mod storage_account_properties {
    ...
    impl FromStr for AllowedCopyScope {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for AllowedCopyScope {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for AllowedCopyScope {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::PrivateLink => serializer.serialize_unit_variant("AllowedCopyScope", 0u32, "PrivateLink"),
                Self::Aad => serializer.serialize_unit_variant("AllowedCopyScope", 1u32, "AAD"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
    ...
    impl FromStr for DnsEndpointType {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for DnsEndpointType {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for DnsEndpointType {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::Standard => serializer.serialize_unit_variant("DnsEndpointType", 0u32, "Standard"),
                Self::AzureDnsZone => serializer.serialize_unit_variant("DnsEndpointType", 1u32, "AzureDnsZone"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
...
pub mod storage_account_sku_conversion_status {
    ...
    #[doc = "This property indicates the current sku conversion status."]
    #[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
    #[serde(remote = "SkuConversionStatus")]
    ...
    impl FromStr for SkuConversionStatus {
        type Err = value::Error;
        fn from_str(s: &str) -> std::result::Result<Self, Self::Err> {
            Self::deserialize(s.into_deserializer())
        }
    }
    impl<'de> Deserialize<'de> for SkuConversionStatus {
        fn deserialize<D>(deserializer: D) -> std::result::Result<Self, D::Error>
        where
            D: Deserializer<'de>,
        {
    ...
    impl Serialize for SkuConversionStatus {
        fn serialize<S>(&self, serializer: S) -> std::result::Result<S::Ok, S::Error>
        where
            S: Serializer,
        {
            match self {
                Self::InProgress => serializer.serialize_unit_variant("SkuConversionStatus", 0u32, "InProgress"),
                Self::Succeeded => serializer.serialize_unit_variant("SkuConversionStatus", 1u32, "Succeeded"),
                Self::Failed => serializer.serialize_unit_variant("SkuConversionStatus", 2u32, "Failed"),
                Self::UnknownValue(s) => serializer.serialize_str(s.as_str()),
            }
        }
    }
